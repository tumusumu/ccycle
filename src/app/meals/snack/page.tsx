...
import { SNACK_PROTEIN_OPTIONS, PROTEIN_DEFAULT_GRAMS } from '@/constants/nutrition';
...
export default function SnackPage() {
  ...
  const handleNutritionSelect = (result: INutritionResult) => {
    ...
    setProteinType('custom');
    setProteinGrams(gramsFor22gProtein);
  };

  // Clear custom food and return to dropdown selection
  const handleClearCustomFood = () => {
    setCustomFood(null);
    setProteinType('proteinPowder');
    setProteinGrams(PROTEIN_DEFAULT_GRAMS.proteinPowder);
  };
